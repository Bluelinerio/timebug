...
export type SelectPutActionFnType = <T>(state: any) => {type: string, payload:T }
export type SelectPutActionType = { type: SELECT_PUT_ACTION, payload: { selectPut: SelectPutActionFnType } }

export function selectPutAction(selectPut: SelectPutActionFnType): SelectPutActionType {
  return {
