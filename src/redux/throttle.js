...
export type ThrottleActionType = { type: SAGA_THROTTLE, payload: ActionToThrottle }

export function throttleAction<T>(payload: ActionToThrottle): ThrottleActionType {
  return {
    type: SAGA_THROTTLE,
    payload
  }
