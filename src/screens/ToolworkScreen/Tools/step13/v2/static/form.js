...
export const FORM_KEYS_PROXY = {
  goal: FORM_KEYS.career_goals_form_goal,
  category: FORM_KEYS.career_goals_form_category,
  length: FORM_KEYS.career_goals_form_how_long,
  steps: FORM_KEYS.career_goals_form_steps,
}
export const CHILDREN_KEYS_PROXY = {
  steps: {
    step: CHILDREN_KEYS.career_goals_form_steps.step_to_life_goal,
  },
}
