...
export const FORM_KEYS = {
  ...
  career_dreams_form_how_long: 'career_dreams_form_how_long',
...
const form: Form = {
  ...
  fields: {
    0: {
      type: types.string,
      key: FORM_KEYS.career_dreams_form_goal,
      content: {
    ...
    1: {
      type: types.select,
      key: FORM_KEYS.career_dreams_form_category,
      content: {
    ...
    2: {
      type: types.select,
      key: FORM_KEYS.career_dreams_form_how_long,
      content: {
    ...
    3: {
      type: types.list,
      key: FORM_KEYS.career_dreams_form_steps,
      content: {
      ...
      options: {
        childTypes: {
          0: {
            type: types.string,
            key: CHILDREN_KEYS.career_dreams_form_steps.step_to_life_goal,
            options: {
              placeHolder: 'Step',
            },
          },
