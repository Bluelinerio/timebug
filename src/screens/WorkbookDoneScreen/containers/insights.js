...
const insights = {
  ...
  '8': `tudies show that if you believe willpower is a limited resource, then you will in fact have a finite source of mental energy. If you believe its endless, then it will be. (Dweck on Ego Depletion).`,
  ...
  '24': `According to research, humans are really bad at predicting what will make them happy. Money brings happiness but to only up until a point. After that, generosity does.`,
  '25:': `You can “catch” extra willpower from the people around you. Goals are contagious.  So if you are dreaming about your bucket list, surround yourself with other people who are trying to accomplish their own.`,
  ...
  '27': `When people reflect on their personal flaws with compassion,  it fosters the belief that they can improve and the ambition to do so.`,
