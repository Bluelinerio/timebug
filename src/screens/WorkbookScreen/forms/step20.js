...
export default {
  ...
  2: {
    ...
    options: {
      ...
      fields: {
        ...
        thingsDoLess: {
          label: 'Has anything changed with your 3 things that you want to DO LESS of in general?',
          help: 'i.e. "Watching TV"'
        },
        thingsDoMore: {
          label: 'Has anything changed with your 3 things that you want to DO MORE of in general?',
          help: 'i.e. "Exercising"'
        }
      }
    }
  ...
  3: {
    ...
    options: {
      label: 'Rank each of the 7 Pillars of Life in order of importance to you over the past 5 years.',
