...
export default {
  1: {
    ...
    options: {
      auto: 'none',
      label: "What are your different energy levels (physical, mental and emotional) at different times of a typical day (morning, afternoon, evening)?",
      fields: {
        id: {
          hidden: true
        },
        weekday: {
          ...
          fields: {
            weekdayMorning: {
              ...
              fields: {
                physical: {
                  label: 'What is your typical physical energy level on a weekday morning?'
                },
                mental: {
                  label: 'What is your typical mental energy level on a weekday morning?'
                },
                emotional: {
                  label: 'What is your typical emotional energy level on a weekday morning?'
                }
              }
            },
            weekdayAfternoon: {
              ...
              fields: {
                physical: {
                  ...
                  label: 'What is your typical physical energy level on a weekday afternoon?'
                },
                mental: {
                  label: 'What is your typical mental energy level on a weekday afternoon?'
                },
                emotional: {
                  label: 'What is your typical emotional energy level on a weekday afternoon?'
                }
              }
            },
            weekdayEvening: {
              ...
              fields: {
                physical: {
                  label: 'What is your typical physical energy level on a weekday evening?'
                },
                mental: {
                  label: 'What is your typical mental energy level on a weekday evening?'
                },
                emotional: {
                  label: 'What is your typical emotional energy level on a weekday evening?'
                }
              }
            }
          }
        ...
        weekend: {
          fields: {
            ...
            weekendAfternoon: {
              ...
              fields: {
                physical: {
                  label: 'What is your typical physical energy level on a weekend afternoon?'
                },
                mental: {
                  label: 'What is your typical mental energy level on a weekend afternoon?'
                },
                emotional: {
                  label: 'What is your typical emotional energy level on a weekend afternoon?'
                }
              }
            },
            weekendEvening: {
              ...
              fields: {
                physical: {
                  label: 'What is your typical physical energy level on a weekend evening?'
                },
                mental: {
                  label: 'What is your typical mental energy level on a weekend evening?'
                },
                emotional: {
                  label: 'What is your typical emotional energy level on a weekend evening?'
                }
              }
            }
          }
