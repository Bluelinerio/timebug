...
const VerticalGradientWithTwoColors = ({startColor='#004E69', endColor ='#0D0D0D', children, style }) => (
  <LinearGradient
    style={{		
      flex: 1
    }}
    ...
    return (
      ...
      <SafeAreaView>
        ...
        <SoundPlayback
          ...
          onReady={ () => this.setState({ soundReady: true, soundPlaying: false }) }
        ...
        {soundReady && 
          <Entypo.Button
            ...
            onPress={ soundPlaying ? () => this.pause : () => this.soundPlayback.play()}
            color={'white'}
            size={88}
