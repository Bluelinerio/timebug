...
export const formEntries = {
    [STEP1]: {
        title: "Component 1",
        render: compose(ExampleFormHOC({ injected: "This is step 1" }), GenericFormConsumer(exampleHandler))(ExampleFormComponent)
    },
    [STEP2]: {
        title: "Your weekly timetable",
        render: compose(GenericFormConsumer(form2Handler), Form2HOC())(Form2Component)
    },
    [STEP3]: {
        title: "Component 3"
    }
