...
import VisionCreationComponent from './VisionCreation'

const VisionCreationContainer = () => {
  ...
  const tool = useMemo(
    () => {
      return unlockedTools.find(
        t => t.key === TOOL_KEYS.VisionCreationDreamsTrackerKey
      )
    },
    [unlockedTools]
  )
  ...
  return <VisionCreationComponent tool={tool} data={toolData} />
}

export default VisionCreationContainer
