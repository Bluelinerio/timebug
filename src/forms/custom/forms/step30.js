   ...
   fields: {
    0: {
        ...
        options: {
          ...
          childTypes: {
            0: {
              ...
              options: {
                label:'What are your biggest hopes for this life category over the coming year, in terms of what you can get done?',
                placeHolder: "I'm optimistic that paying greater attention to my physical health will leave me feeling better throughout the day, thus working much more efficiently...",
                default: '',
                multiline: true,
                required: true,
                numberOfLines: 4,
            ...
            1: {
              ...
              options: {
                ...
                placeHolder: 'I am worried I will not overcome my social anxiety which holds me back in the workplace',
                default: '',
                multiline: true,
                numberOfLines:4,
                style: {
     ...
     2: {
        ...
        content: {
          text:
            'Life Category: Special Projects',
        ...
        options: {
          ...
          childTypes: {
            0: {
              ...
              options: {
                label:'What are your biggest hopes for this life category over the coming year, in terms of what you can get done?',
                placeHolder: "I would like to finally get that online store up and running...",
                default: '',
                multiline: true,
                required: true,
                numberOfLines: 4,
            ...
            1: {
              ...
              options: {
                label:'What are your greatest fears?',
                placeHolder: 'Outside of work and family, there is hardly any time and I am usually very tired...',
                default: '',
                multiline: true,
                numberOfLines:4,
                style: {
        ...
        options: {
          ...
          childTypes: {
            0: {
              ...
              options: {
                label:'What are your biggest hopes for this life category over the coming year, in terms of what you can get done?',
                placeHolder: "I will finally commit to meditating 30 minutes every morning, no matter what...",
                default: '',
                multiline: true,
                required: true,
                numberOfLines: 4,
            ...
            1: {
              ...
              options: {
                label:'What are your greatest fears?',
                placeHolder: 'I worry about what some of my family members will think of my new spiritual practice...',
                default: '',
                multiline: true,
                numberOfLines:4,
                style: {
     ...
     4: {
        ...
        content: {
          text:
            'Life Category: Skills and Education',
        ...
        options: {
          ...
          childTypes: {
            0: {
              ...
              options: {
                label:'What are your biggest hopes for this life category over the coming year, in terms of what you can get done?',
                placeHolder: "Now is the time for me to research and apply to the best Masters program in my field...",
                default: '',
                multiline: true,
                required: true,
                numberOfLines: 4,
            ...
            1: {
              ...
              options: {
                label:'What are your greatest fears?',
                placeHolder: 'I often feel that I am too old to be learning anything new...',
                default: '',
                multiline: true,
                numberOfLines:4,
                style: {
        ...
        options: {
          ...
          childTypes: {
            0: {
              ...
              options: {
                label:'What are your biggest hopes for this life category over the coming year, in terms of what you can get done?',
                placeHolder: "I will prioritize getting 7-8 hours of sleep every night which will in turn effect all my other Life Categories positively",
                default: '',
                multiline: true,
                required: true,
                numberOfLines: 4,
            ...
            1: {
              ...
              options: {
                label:'What are your greatest fears?',
                placeHolder: 'I like to stay up late and have time for myself at the end of the day, but it effects my sleep, makes me skip breakfast, etc...',
                default: '',
                multiline: true,
                numberOfLines:4,
                style: {
        ...
        options: {
          ...
          childTypes: {
            0: {
              ...
              options: {
                label:'What are your biggest hopes for this life category over the coming year, in terms of what you can get done?',
                placeHolder: "I will devote one day of every weekend completely to spending time with family",
                default: '',
                multiline: true,
                required: true,
                numberOfLines: 4,
            ...
            1: {
              ...
              options: {
                label:'What are your greatest fears?',
                placeHolder: "I worry I have alienated some close friends over the last few years due to being hyper focused on my work...",
                default: '',
                multiline: true,
                numberOfLines:4,
                style: {
        ...
        options: {
          ...
          childTypes: {
            0: {
              ...
              options: {
                label:'What are your biggest hopes for this life category over the coming year, in terms of what you can get done?',
                placeHolder: "I know that I can loose 30 pounds with some simple diet changes and regular exercise...",
                default: '',
                multiline: true,
                required: true,
                numberOfLines: 4,
            ...
            1: {
              ...
              options: {
                label:'What are your greatest fears?',
                placeHolder: 'Of all the things I love in life, carbs may be the hardest to give up...',
                default: '',
                multiline: true,
                numberOfLines:4,
                style: {
